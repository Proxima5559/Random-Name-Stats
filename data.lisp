...
(defparameter *names*
              '((:id 1
                ...
                (:id 42
                     ...
                     :status "Ավանդական"
                     :era "ancient/medieval"
                     :diminutives ("Բաբո" "Բաբիկ")
                     :famous-people ("Բաբկեն Ա կաթողիկոս" "Բաբկեն Ներսիսյան")
                     :related-names ("Բաբ")
                     :tags ("հայր" "հարգարժան" "եկեղեցական")
                     :desc "Ծագում է «բաբ» (հայր, պապ) արմատից՝ ավելացրած փաղաքշական «կեն» մասնիկը։ Նշանակում է «հայրիկ»։")
                ...
                (:id 43
                     ...
                     :status "Պատմական"
                     :era "ancient/medieval"
                     :diminutives ("Բագրատիկ" "Բագո")
                     :famous-people ("Բագրատ Գալստանյան" "Բագրատ Բագրատունի")
                     :related-names ("Բագրատունի" "Բագարատ")
                     :tags ("աստվածատուր" "արքայական" "Բագրատունյաց հարստություն")
                     :desc "Հին իրանական ծագմամբ անուն (Bagadata), որը թարգմանաբար նշանակում է «Աստծո տված» կամ «աստվածատուր»։ Բագրատունյաց թագավորական տոհմի հիմնադիր անուններից է։")
                ...
                (:id 44
                     ...
                     :status "Ավանդական"
                     :era "ancient/medieval"
                     :diminutives ("Բարս" "Բարսեղիկ")
                     :famous-people ("Բարսեղ Կանաչյան" "Բարսեղ Մաշկևորցի")
                     :related-names ("Վասիլ" "Բասիլ")
                     :tags ("թագավորական" "իշխանական" "եկեղեցական")
                     :desc "Հունական «Վասիլիոս» անվան հայկական տարբերակն է, որը նշանակում է «թագավորական» կամ «արքայական»։")
                ...
                (:id 45
                     ...
                     :status "Ժամանակակից"
                     :era "modern"
                     :diminutives ("Բեն" "Բենո")
                     :famous-people ("Բենիկ Թումանյան")
                     :related-names ("Բենիամին" "Բենեդիկտ")
                     :tags ("օրհնյալ" "բարերար")
                     :desc "Լատինական ծագմամբ «Բենեդիկտոս» անվան կրճատ, հայկականացված տարբերակն է, որը նշանակում է «օրհնյալ»։")
                ...
                (:id 46
                     ...
                     :status "Միջազգային"
                     :era "ancient"
                     :diminutives ("Գաբո" "Գաբրի")
                     :famous-people ("Գաբրիել Սունդուկյան" "Գաբրիել հրեշտակապետ")
                     :related-names ("Գաբրիելա")
                     :tags ("աստվածաշնչյան" "ուժ" "հրեշտակապետ")
                     :desc "Եբրայական անուն, որը նշանակում է «Աստված իմ ուժն է» կամ «Աստծո մարդ»։ Քրիստոնեական ավանդության մեջ գլխավոր հրեշտակապետերից մեկի անունն է։")
                ...
                (:id 47
                     ...
                     :era "medieval"
                     :diminutives ("Գագո")
                     :famous-people ("Գագիկ Ա թագավոր" "Գագիկ Ծառուկյան")
                     :related-names ("Գագ")
                     :tags ("արքայական" "իշխանավոր" "Բագրատունիներ")
                     :desc "Հին հայկական թագավորական անուն, որը ծագում է «գագ» (գագաթ, բարձունք) արմատից՝ նշանակելով «բարձրունքում գտնվող տիրակալ»։")
                ...
                (:id 48
                     ...
                     :status "Պատմական"
                     :era "ancient/modern"
                     :diminutives ("Գարիկ" "Գարո")
                     :famous-people ("Գարեգին Նժդեհ" "Գարեգին Բ Ամենայն Հայոց Կաթողիկոս" "Գարեգին Սրվանձտյանց")
                     :related-names ("Գարե")
                     :tags ("ազգային" "զորավար" "իմաստություն")
                     :desc "Հին հայկական անուն, որի ստույգ նշանակությունը մնում է վիճելի, սակայն հաճախ կապվում է «գրագետ», «իմաստուն» կամ «կրակ» հասկացությունների հետ։ Սերտորեն կապված է ռազմական ու հոգևոր գործիչների հետ։")

                (:id 49
                     :gender "male"
                     :arm "Գասպար"
                     :lat "Gaspar"
                     :origin "Իրանական/Ասորական"
                     :status "Ավանդական"
                     :era "ancient"
                     :diminutives ("Գասպո" "Գապո")
                     :famous-people ("Գասպար Իփեկյան")
                     :related-names ("Կասպար")
                     :tags ("աստվածաշնչյան" "գանձապահ" "մոգ")
                     :desc "Ծագում է հին պարսկերենից, նշանակում է «գանձապահ» կամ «գանձերը պահպանող»։ Ըստ քրիստոնեական ավանդության՝ Հիսուսին երկրպագելու եկած երեք մոգերից մեկի անունն է։")
                ...
                (:id 50
                     ...
                     :status "Պատմական"
                     :era "ancient"
                     :diminutives ("Գեղամիկ" "Գեղո")
                     :famous-people ("Գեղամ Սևան" "Գեղամ նահապետ")
                     :related-names ("Գեղանուշ")
                     :tags ("նահապետ" "Գեղամա լեռներ" "Սևան")
                     :desc "Հայկ նահապետի տոհմից Սիսակի որդու՝ Գեղամ նահապետի անունն է։ Նրա անունով են կոչվում Գեղամա լեռները և Գեղամա ծովը (Սևանա լիճը)։")))
